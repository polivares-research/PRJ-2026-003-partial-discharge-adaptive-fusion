...
def build_audit(config_path: Path, raw_root: Path | None) -> dict:
    ...
    return {
        ...
        "external_workspace": {
            "path": str(external_workspace),
            "available": external_workspace.is_dir(),
        ...
        "literature_items": [
            {
                "item": "moving average 10000 and zero-crossing phase alignment",
                "status": "VERIFIED_FROM_PAPER",
                "v5_status": "ADAPTED_TO_SIGNAL_LEVEL",
            },
            {
                "item": "alpha=100 beta=1 high-pass flattening",
                "status": "VERIFIED_FROM_PAPER",
                "v5_status": "ADAPTED_TO_SIGNAL_LEVEL",
            },
            {
                "item": "Np=257, wt=128, wf=512",
                "status": "VERIFIED_FROM_PAPER",
                "v5_status": "CANDIDATE_POLICY_NOT_YET_FROZEN",
            },
            {
                "item": "public reference implementation and exact training source",
                "status": "UNAVAILABLE_UNTIL_PROVENANCE_LICENSE_REVIEW",
                "v5_status": "NO_EXTERNAL_CODE_OR_WEIGHTS_USED",
            },
            {
                "item": "measurement-level any-phase label aggregation",
                "status": "NOT_COMPATIBLE_WITH_V5_SIGNAL_LEVEL_UNIT",
                "v5_status": "LITERATURE-INSPIRED_SIGNAL-LEVEL-ADAPTATION",
            },
        ],
        "cycle_consistency": {
            "default": "disabled_until_phase_alignment_is_proven",
...
def main(argv: list[str] | None = None) -> int:
    ...
    audit = build_audit(args.config, args.raw_root)
